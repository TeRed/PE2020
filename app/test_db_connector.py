...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_all_articles(self):
        # Given
        articles = [
            {"id": "1", "name": "Test", "quantity": 2, "is_available": True},
            {"id": "2", "name": "Test2", "quantity": 2, "is_available": False}
        ]
        ...
        expected = [
            Article('1', 'Test', 2, True),
            Article('2', 'Test2', 2, False)
        ]
    ...
    def test_get_articles_by_name(self):
        ...
        search_string = 'eSt2'
        expected = [Article('2', "Test2", 2, False)]
    ...
    def test_get_articles_by_availability(self):
        ...
        articles = [
            {"id": "1", "name": "Test", "quantity": 2, "is_available": True},
            {"id": "2", "name": "Test2", "quantity": 2, "is_available": False},
            {"id": "3", "name": "Test3", "quantity": 4, "is_available": False}
        ]
    ...
    def test_add_article(self):
        ...
        article = Article('1', "Test", 2, False)
        expected = [Article('1', "Test", 2, False)]
    ...
    def test_add_article_2(self):
        ...
        article = Article('1', "Test", 2, False)
        article2 = Article('1', "Test2", 2, False)
        expected = [Article('1', "Test", 2, False)]
    ...
    def test_add_article_3(self):
        ...
        article = Article('1', "Test", 2, False)
        article2 = Article('2', "Test2", 2, False)
        expected = [Article('1', "Test", 2, False), Article('2', "Test2", 2, False)]
    ...
    def test_remove_article_by_id(self):
        # Given
        articles = [{"id": "1", "name": "Test", "quantity": 2, "is_available": False}]
    ...
    def test_change_article_availability(self):
        ...
        search_id = '2'
        expected = Article('2', "Test2", 2, True)
